...
import { newsletterFormSchema } from './NewsletterForm';
...
export const NewsletterSettingsForm = ({
  defaultValues,
  onSubmit,
  isPending = false,
  error,
  ...
  return (
    ...
    >
      <SettingsSection>
        <SettingsRow
          title="Name"
          description="Appears as the email subject line."
        >
        ...
        <SettingsRow
          title="Schedule"
          description="How often and when issues are sent."
        >
