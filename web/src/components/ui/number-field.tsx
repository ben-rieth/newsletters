...
function NumberFieldGroup({
  ...
  return (
    <NumberFieldPrimitive.Group
      ...
      className={cn(
        "flex h-7 w-full min-w-0 items-center rounded-md border border-input bg-input/20 transition-colors",
...
type NumberFieldProps = React.ComponentProps<typeof NumberFieldPrimitive.Root> & {
  id?: string
