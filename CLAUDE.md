...
- **Routing:** TanStack Router with file-based routing in `src/routes/`. The route tree (`routeTree.gen.ts`) is auto-generated — do not edit it manually. Prefer directory routes (newsletters/$newsletterId.tsx) to flat routes (newsletters.$newsletterId.tsx).
